...
#define INSTRUCTION_WORD(x) __asm__ __volatile__(".word (%0)" : : "i" ((x))); ckernel::inst_trace[ckernel::inst_trace_ptr++] = ((uint32_t)x)
...
#define INSTRN_BUFFER_PUT(x) ckernel::instrn_buffer[0] = (x); ckernel::inst_trace[ckernel::inst_trace_ptr++] = (TRISC_OP_SWIZZLE(((uint32_t)x)))
...
INSTRN_BUFFER_PUT( TT_OP_ADDDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_ADDRCRXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask) )
...
INSTRN_BUFFER_PUT( TT_OP_ADDRCRZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask) )
...
INSTRN_BUFFER_PUT( TT_OP_APOOL3S1(clear_dvalid, addr_mode, index_en, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_APOOL3S2(clear_dvalid, addr_mode, index_en, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_ATCAS(MemHierSel, SwapVal, CmpVal, Sel32b, DataRegIndex, AddrRegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_ATGETM(mutex_index) )
...
INSTRN_BUFFER_PUT( TT_OP_ATINCGET(MemHierSel, WrapVal, Sel32b, DataRegIndex, AddrRegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_ATINCGETPTR(MemHierSel, NoIncr, IncrVal, WrapVal, Sel32b, DataRegIndex, AddrRegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_ATRELM(mutex_index) )
...
INSTRN_BUFFER_PUT( TT_OP_ATSWAP(MemHierSel, SwapMask, DataRegIndex, AddrRegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_BITWOPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_CLEARDVALID(cleardvalid, reset) )
...
INSTRN_BUFFER_PUT( TT_OP_CMPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_CONV3S1(clear_dvalid, rotate_weights, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_CONV3S2(clear_dvalid, rotate_weights, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_DOTPV(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_ELWADD(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_ELWMUL(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_ELWSUB(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_FLUSHDMA(FlushSpec) )
...
INSTRN_BUFFER_PUT( TT_OP_GAPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_GATESRCRST(reset_srcb_gate_control, reset_srca_gate_control) )
...
INSTRN_BUFFER_PUT( TT_OP_GMPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_INCADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X) )
...
INSTRN_BUFFER_PUT( TT_OP_INCADCZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X) )
...
INSTRN_BUFFER_PUT( TT_OP_INCRWC(rwc_cr, rwc_d, rwc_b, rwc_a) )
...
INSTRN_BUFFER_PUT( TT_OP_LOADIND(SizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_LOADREG(TdmaDataRegIndex, RegAddr) )
...
INSTRN_BUFFER_PUT( TT_OP_MFCONV3S1(clear_dvalid, rotate_weights, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MOP(mop_type, loop_count, zmask_lo16) )
...
INSTRN_BUFFER_PUT( TT_OP_MOP_CFG(zmask_hi16) )
...
INSTRN_BUFFER_PUT( TT_OP_MOVA2D(dest_32b_lo, src, addr_mode, instr_mod, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MOVB2A(srca, addr_mode, instr_mod, srcb) )
...
INSTRN_BUFFER_PUT( TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, instr_mod, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MOVD2A(dest_32b_lo, src, addr_mode, instr_mod, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MOVDBGA2D(dest_32b_lo, src, addr_mode, instr_mod, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MPOOL3S1(clear_dvalid, addr_mode, index_en, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MPOOL3S2(clear_dvalid, addr_mode, index_en, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_MULDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_MVMUL(clear_dvalid, instr_mod19, addr_mode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_PACR(AddrMode, ZeroWrite, PackSel, OvrdThreadId, Concat, Flush, Last) )
...
INSTRN_BUFFER_PUT( TT_OP_PACR_SETREG(Push, AddrSel, WrData, PackSel, StreamId, Flush, Last) )
...
INSTRN_BUFFER_PUT( TT_OP_RDCFG(GprAddress, CfgReg) )
...
INSTRN_BUFFER_PUT( TT_OP_REG2FLOP(SizeSel, TargetSel, ByteOffset, ContextId_2, FlopIndex, RegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_REPLAY(start_idx, len, execute_while_loading, load_mode) )
...
INSTRN_BUFFER_PUT( TT_OP_RMWCIB0(Mask, Data, CfgRegAddr) )
...
INSTRN_BUFFER_PUT( TT_OP_RMWCIB1(Mask, Data, CfgRegAddr) )
...
INSTRN_BUFFER_PUT( TT_OP_RMWCIB2(Mask, Data, CfgRegAddr) )
...
INSTRN_BUFFER_PUT( TT_OP_RMWCIB3(Mask, Data, CfgRegAddr) )
...
INSTRN_BUFFER_PUT( TT_OP_SEMGET(sem_sel) )
...
INSTRN_BUFFER_PUT( TT_OP_SEMINIT(max_value, init_value, sem_sel) )
...
INSTRN_BUFFER_PUT( TT_OP_SEMPOST(sem_sel) )
...
INSTRN_BUFFER_PUT( TT_OP_SEMWAIT(stall_res, sem_sel, wait_sem_cond) )
...
INSTRN_BUFFER_PUT( TT_OP_SETADC(CntSetMask, ChannelIndex, DimensionIndex, Value) )
...
INSTRN_BUFFER_PUT( TT_OP_SETADCXX(CntSetMask, x_end2, x_start) )
...
INSTRN_BUFFER_PUT( TT_OP_SETADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask) )
...
INSTRN_BUFFER_PUT( TT_OP_SETADCZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask) )
...
INSTRN_BUFFER_PUT( TT_OP_SETASHRMH(reg_mask, halo_mask) )
...
INSTRN_BUFFER_PUT( TT_OP_SETASHRMH0(reg_mask, halo_mask) )
...
INSTRN_BUFFER_PUT( TT_OP_SETASHRMH1(reg_mask, halo_mask) )
...
INSTRN_BUFFER_PUT( TT_OP_SETASHRMV(reg_mask2) )
...
INSTRN_BUFFER_PUT( TT_OP_SETC16(setc16_reg, setc16_value) )
...
INSTRN_BUFFER_PUT( TT_OP_SETDMAREG(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b) )
...
INSTRN_BUFFER_PUT( TT_OP_SETDVALID(setvalid) )
...
INSTRN_BUFFER_PUT( TT_OP_SETIBRWC(rwc_cr, rwc_bias, set_inc_ctrl) )
...
INSTRN_BUFFER_PUT( TT_OP_SETPKEDGOF(y_end, y_start, x_end, x_start) )
...
INSTRN_BUFFER_PUT( TT_OP_SETRWC(clear_ab_vld, rwc_cr, rwc_d, rwc_b, rwc_a, BitMask) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPABS(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPADD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPADDI(imm16_math, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPAND(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPCAST(lreg_src_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPCOMPC(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPCONFIG(imm16_math, config_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPDIVP2(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPENCC(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPEXEXP(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPEXMAN(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPIADD(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPLOADI(lreg_ind, instr_mod0, imm16) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPLUT(lreg_ind, instr_mod0, dest_reg_addr) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPLUTFP32(lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPLZ(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPMAD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPMOV(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPMUL(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPMULI(imm16_math, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPNOT(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPOR(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPPOPC(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPPUSHC(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSETCC(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSETEXP(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSETMAN(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSETSGN(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSHFT(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSHFT2(imm12_math, lreg_src_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPSWAP(imm12_math, lreg_src_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPTRANSP(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFPXOR(imm12_math, lreg_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SFP_STOCH_RND(rnd_mode, imm8_math, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) )
...
INSTRN_BUFFER_PUT( TT_OP_SHIFTDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_SHIFTXA(log2_amount2, shift_mode) )
...
INSTRN_BUFFER_PUT( TT_OP_SHIFTXB(addr_mode, rot_shift, shift_row) )
...
INSTRN_BUFFER_PUT( TT_OP_STALLWAIT(stall_res, wait_res) )
...
INSTRN_BUFFER_PUT( TT_OP_STOREIND(MemHierSel, SizeSel, RegSizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_STOREREG(TdmaDataRegIndex, RegAddr) )
...
INSTRN_BUFFER_PUT( TT_OP_SUBDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) )
...
INSTRN_BUFFER_PUT( TT_OP_UNPACR(Unpack_block_selection, AddrMode, CfgContextCntInc, CfgContextId, AddrCntContextId, OvrdThreadId, SetDatValid, rareb_en, ZeroWrite2, AutoIncContextID, RowSearch, SearchCacheFlush, Last) )
...
INSTRN_BUFFER_PUT( TT_OP_UNPACR_NOP(Unpack_block_selection, NoOp) )
...
INSTRN_BUFFER_PUT( TT_OP_WRCFG(GprAddress, wr128b, CfgReg) )
...
INSTRN_BUFFER_PUT( TT_OP_XMOV(Mov_block_selection, Last) )
...
INSTRN_BUFFER_PUT( TT_OP_ZEROACC(clear_mode, AddrMode, dst) )
...
INSTRN_BUFFER_PUT( TT_OP_ZEROSRC(zero_val, write_mode, bank_mask, src_mask) )
